...
<?php else: ?>
    ...
    <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <!-- Card 2: Kelola Pesanan -->
        <a href="<?= base_url('manage') ?>" class="bg-white shadow rounded-lg p-6 flex flex-col justify-between hover:bg-gray-100 transition duration-300 ease-in-out border-2 border-blue-300">
