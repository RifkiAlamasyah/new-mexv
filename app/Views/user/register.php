...
<h1 class="text-center font-medium text-xl">Register</h1>
...
<div class="mb-5">
  ...
  <div class="mb-5">
    ...
    <label for="jenis_kelamin_L" class="block ms-2  text-sm font-medium text-gray-900 dark:text-gray-300">
      Laki-Laki
    </label>
    <input id="jenis_kelamin_P" type="radio" name="jenis_kelamin" value="perempuan" class="ms-4 w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
    <label for="jenis_kelamin_P" class="block ms-2  text-sm font-medium text-gray-900 dark:text-gray-300">
      Perempuan
    </label>
  </div>
  </div>
